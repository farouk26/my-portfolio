...
function EducationCard({ title, subtitle, year, location }) {
  return (
    <div className="flex lg:flex-row flex-col gap-4 items-center w-full bg-gray-50 p-4 rounded-3xl transition lg:hover:scale-105 duration-400 lg:cursor-pointer">
      {/* Job Section */}
