...
function Layout({ children }) {
  return (
    <main
      className={`${poppins.variable} font-poppins grid grid-cols-5 min-h-fit bg-white w-full`}
    >
      ...
      <div className="lg:col-span-4 col-span-5 px-8 pt-6 w-full overflow-y-auto">
        <span className="badge rounded-xl bg-emerald-50 text-green-500 font-semibold text-sm border-opacity-5 p-3 my-5 flex items-center gap-1">
          <GoDotFill />
          Available For Work
        </span>
        {children}
