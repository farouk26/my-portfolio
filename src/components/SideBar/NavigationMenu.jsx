...
function NavigationMenu() {
  return (
    <div className="flex flex-col gap-4 py-12 px-4 w-full min-h-fit justify-start text-black">
      <Link
        className="btn flex gap-4 items-center justify-start btn-ghost rounded-2xl text-sm"
        href="/"
      >
